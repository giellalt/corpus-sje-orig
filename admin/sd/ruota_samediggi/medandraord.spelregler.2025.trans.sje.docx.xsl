...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'medandraord.spelregler.2025.trans.sje.docx'"/>
    ...
    <!-- Automatically filled in by CorpusTools -->
    <xsl:variable name="mainlang" select="'sje'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="medandraord.spelregler.2025.trans.sma.docx"/>
        <parallel_text xml:lang="sme" location="medandraord.spelregler.2025.orig.sme.docx"/>
        <parallel_text xml:lang="smj" location="medandraord.spelregler.2025.trans.smj.docx"/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location=""/>
        <parallel_text xml:lang="swe" location=""/>
    <parallel_text xml:lang="sju" location="medandraord.spelregler.2025.trans.sju.docx"/>
</xsl:variable>
