...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'sje18930000a-halasz1893a-22'"/>
    <xsl:variable name="text_encoding" select="'UTF-8'"/>
    <xsl:variable name="title" select="'Gidniha'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Ignasz'"/>
    <xsl:variable name="author1_ln" select="'Halász'"/>
    <!-- m, f or unknown -->
    ...
    -->
    <xsl:variable name="author1_nat" select="'HUN'"/>
    <!-- Either YYYY or YYYYMMDD. Examples: 1954 or 19451224 -->
    <xsl:variable name="author1_born" select="'185500526'"/>
    <!--
